  ...
  en: {
    ...
    levels: [
      ...
      },
      {
        ...
        badge: "Elementary",
        sections: [
          { id: 9, title: "Introduction to Verbs", arabic: "الفعل", desc: "Past, present and command forms", ready: false },
          { id: 10, title: "The Nominal Sentence", arabic: "الجملة الاسمية", desc: "Subject and predicate structure", ready: false },
          { id: 11, title: "The Verbal Sentence", arabic: "الجملة الفعلية", desc: "Verb-first sentence structure", ready: false },
          { id: 12, title: "Doer & Object", arabic: "الفاعل والمفعول به", desc: "Who does what to whom", ready: false },
          { id: 13, title: "Possession Structure", arabic: "الإضافة", desc: "Mudaf and Mudaf Ilayh", ready: false },
        ],
      },
      {
        level: "Level 4",
  ...
  ur: {
    ...
    levels: [
      ...
      },
      {
        ...
        badge: "ابتدائی متوسط",
        sections: [
          { id: 9, title: "فعل کا تعارف", arabic: "الفعل", desc: "ماضی، مضارع اور امر", ready: false },
          { id: 10, title: "جملہ اسمیہ", arabic: "الجملة الاسمية", desc: "مبتدا اور خبر", ready: false },
          { id: 11, title: "جملہ فعلیہ", arabic: "الجملة الفعلية", desc: "فعل سے شروع ہونے والا جملہ", ready: false },
          { id: 12, title: "فاعل اور مفعول", arabic: "الفاعل والمفعول به", desc: "کون کیا کرتا ہے", ready: false },
          { id: 13, title: "اضافت", arabic: "الإضافة", desc: "مضاف اور مضاف الیہ", ready: false },
        ],
      },
      {
        level: "لیول 4",
